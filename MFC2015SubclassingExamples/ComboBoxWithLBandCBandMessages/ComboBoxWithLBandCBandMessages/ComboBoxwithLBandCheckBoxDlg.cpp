...
BEGIN_MESSAGE_MAP(CComboBoxwithLBandCheckBoxDlg, CDialog)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_CBN_SELCHANGE(IDC_COMBO1, &CComboBoxwithLBandCheckBoxDlg::OnSelchangeCombo1)
END_MESSAGE_MAP()
...
BOOL CComboBoxwithLBandCheckBoxDlg::OnInitDialog()
{
	...
	m_ComboBox.EnableCheckbox(1, 0);
	m_ComboBox.EnableCheckbox(2, 0);
	m_ComboBox.SetCheck(0, 0);
	m_ComboBox.SetCheck(1, 0);
	m_ComboBox.SetCheck(2, 0);
...
void CComboBoxwithLBandCheckBoxDlg::OnSelchangeCombo1()
{
	MessageBox(CString("Selchange"), CString("Debug"));
